...
- Solved
  ...
  - Divide And Conquer
    - 2025-04
      ...
      - [BOJ 1780] 종이의 개수: NumberOfPapers.java
    - 2025-05
      - (Solving) [BOJ 10830] 행렬 제곱: MatrixSquared.java
  ...
  - DFS and BFS
    ...
    - 2025-07
      - [BOJ 2178] 미로탐색 (BFS only): MazeNavigation.java
...
- Solved
  * Java
    ...
    * MySQL : TODO : MySQL setting
      ...
      - 2025-01
        - [level 1] 평균 일일 대여 요금 구하기: AverageDailyRentalFee.sql
    ...
    * 깊이/너비 우선 탐색(DFS/BFS)
      ...
      - 2024-11
        ...
        - [level 3] 단어 변환: WordConversion.java
          - 좀 더 쉽게 생각해볼 것 / DFS & BFS (둘 다 해결해보기)
 ...
 * SQL
   * Easy
     ...
     - 2026-01
       ...
       - [Num. 182] Duplicate Emails: DuplicateEmails.sql
